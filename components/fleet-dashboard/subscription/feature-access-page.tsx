...
const featureConfig = {
  integrations: {
    title: "Integrations",
    subtitle: "Connect procurement, accounting, logistics, payments, and notification tools allowed by the current plan.",
    features: [
  ...
  security: {
    title: "Security",
    subtitle: "Review staff access, permission depth, audit visibility, and account activity.",
    features: [
...
export function FleetFeatureAccessPage({ access, area }: { access?: BusinessAccess; area: FeatureArea }) {
