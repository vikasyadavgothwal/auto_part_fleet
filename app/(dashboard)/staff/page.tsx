...
import { FleetStaffPage } from "@/components/fleet-dashboard/staff/staff-page"
import {
  type BusinessAccessEntry,
  type BusinessAccessPayload,
  type MembersResponse,
  type RolesResponse,
} from "@/components/fleet-dashboard/staff/types"
...
export default async function FleetStaffPageRoute() {
  ...
  return <FleetStaffPage access={access} membersPayload={membersPayload} rolesPayload={rolesPayload} />
}
