...
import { FleetFeatureAccessPage, type BusinessAccess } from "@/components/fleet-dashboard/subscription/feature-access-page"
...
export default async function IntegrationsPage() {
  ...
  return <FleetFeatureAccessPage access={access} area="integrations" />
}
